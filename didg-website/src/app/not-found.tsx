    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 text-center relative overflow-hidden">
      ...
      <div className="space-y-6 animate-in fade-in zoom-in duration-500">
        ...
        <div className="relative w-40 h-40 mx-auto">
             {/* Usa este link o descarga uno localmente */}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            <button 
                // Next.js maneja el 'back' con el navegador, pero un link simple funciona mejor
                // O puedes usar un router.back() con un componente cliente
                onClick={() => window.history.back()} // Truco rápido para ir atrás (requiere 'use client' si lo extraes, pero como Link a courses es mejor)
